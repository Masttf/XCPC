...
void solve(){
    ...
    for(int i = 1; i < n; i++){
    	...
    	if(rr >= ll){
    		res += cal2(rr - ll + 1);
			res += cal1(cal1(l2 - l, r2 - l, r2 - l2 + 1), 
			    				cal1(l2 - (ll - 1), r2 - (ll - 1), r2 - l2 + 1),
			    				ll - l);
	    	if(r > rr){
	    		res += cal1(cal1(rr + 1 - r2, rr + 1 - l2, r2 - l2 + 1),
	    					cal1(r - r2, r - l2, r2 - l2 + 1),
	    					r - (rr + 1) + 1);
	    	}
	    	if(r2 > rr){
	    		res += cal1(cal1(rr + 1 - r, rr + 1 - l, r - l + 1),
	    					cal1(r2 - r, r2 - l, r - l + 1),
	    					r2 - (rr + 1) + 1);
	    	}
    	}else{
    		res += cal1(cal1(l2 - l, r2 - l, r2 - l2 + 1), 
			    				cal1(l2 - r, r2 - r, r2 - l2 + 1),
			    				r - l + 1);
    	}
    	// mint sum = 0;
    	// for(int j = l; j <= r; j++){
    	...
    	// }
    	// dbg(res, sum);
    	ans += res * mint((r2 - l2 + 1) * (r - l + 1)).inv();
    }
    cout << ans << '\n';
    return ;
}
